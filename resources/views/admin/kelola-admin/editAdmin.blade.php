            ...
            <form method="post" action="{{route('admin-master-edit-admin-submit', $admin->id)}}" enctype="multipart/form-data">
                ...
                <div class="table_section padding_infor_info">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control @error('password_admin') is-invalid @enderror" name="password_admin" placeholder="Masukkan password jika ingin diubah" spellcheck="disabled">
