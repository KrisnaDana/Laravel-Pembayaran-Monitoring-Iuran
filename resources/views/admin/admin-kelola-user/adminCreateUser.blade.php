...
<div class="row">
    <div class="col">
        <div class="white_shd full margin_bottom_30">
            <form method="post" action="{{ route('admin-create-user-submit') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control @error('konfirmasi_password_user') is-invalid @enderror" name="konfirmasi_password_user" value="{{old('konfirmasi_password_user')}}" placeholder="Masukkan password" spellcheck="disabled" required>
