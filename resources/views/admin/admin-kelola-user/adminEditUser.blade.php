...
<div class="row">
    <div class="col">
        <div class="white_shd full margin_bottom_30">
            <form id="editSubmit" method="post" action="{{ route('admin-edit-user-submit', $user->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="table_section padding_infor_info">
                    ...
                    <div class="mt-2 mb-3">
                        ...
                        <form id="deleteFoto{{$user->id}}" action="{{ route('admin-delete-foto-user', $user->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
